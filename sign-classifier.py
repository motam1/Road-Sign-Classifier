...
IMG_WIDTH = 30
IMG_HEIGHT = 30
NUM_CATEGORIES = 3  # Uncomment for gtsrb-small
# NUM_CATEGORIES = 43   # Uncomment for gtsrb
TEST_SIZE = 0.4
...
def load_data(data_dir):
    ...
    for category in range(NUM_CATEGORIES):
        ...
        for file in os.listdir(category_path):
            ...
            # Resize image and append to images list along with corresponding category label
